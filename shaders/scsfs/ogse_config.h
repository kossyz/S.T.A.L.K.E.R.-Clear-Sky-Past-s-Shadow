...
/////////////////////////////////////////////////////////////
// Вода
	#define WATER_ENV_POWER float (1000.2)				// интенсивность отражения скайкуба на воде
	...
	#define SW_REFL_INTENSITY float(0.001)			// интенсивность "честных" отражений
	#define SW_PUDDLES_REFL_INTENSITY float(3.0)	// интенсивность "честных" отражений в лужах
	#define MOON_ROAD_INTENSITY float(0.05)			// интенсивность "лунной дорожки"
...
// Эффекты, связанные с дождем
	...
	#define RAIN_MAX_REFLECTION_POWER float(10.1)			// максимальная сила отражений
	#define RAIN_WETTING_SPEED float(0.5)					// скорость намокания поверхностей
	#define RAIN_GAIN_REFLECTIONS float(30.0)				// усиление честных отражений на намокших поверхностях
