...
//#define W_POSITION_SHIFT_HEIGHT (3.001f/100.0f)	//(1.f/100.f)	//amplitude /50 - small, /10 - large
#define W_POSITION_SHIFT_HEIGHT (1.001f/50.0f)	//(1.f/100.f)	//amplitude /50 - small, /10 - large
#define W_POSITION_SHIFT_SPEED	(25.0f)		//(25.0f)
#define W_DISTORT_BASE_TILE_0	(2.0f)		//(1.0f)
#define W_DISTORT_BASE_TILE_1	(10.0f)		//(1.1f)
#define W_DISTORT_AMP_0		(+0.10f)	//(+0.15f)
#define W_DISTORT_AMP_1		(+0.10f)	//(-0.30f)
#define W_DISTORT_POWER		(1.0f)		//(1.0f)
